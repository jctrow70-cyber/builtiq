...
**BIQ-0218 Phase 2A.2** can recommend the next comparable exposure from logged performance. Do not start Phase 2A.3 (write those decisions onto future planned sets / weeks) until that work is explicitly approved.
