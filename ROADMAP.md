...
1. **Program Design overhaul (BIQ-0136)** — planning is separate from Training execution (Decision 030). Training calendar is always on; programs overlay start/end dates; personal recurring activities are supported (BIQ-0155). Planned workouts can be viewed and edited without starting a log (BIQ-0156). Remaining: occurrence-level recurring edits, richer activity builders, and program edit-from-prompt.
