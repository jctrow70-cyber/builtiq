...
- Honor athlete.notes when they specify counts (e.g. 2 glute / chest / bicep exercises per day). Those are dedicated movements for that muscle. A squat does not count as a glute exercise; a close-grip press does not count as a biceps exercise.
