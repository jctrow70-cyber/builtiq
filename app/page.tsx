...
export default function Page(){
 ...
 function renderExerciseLogContext(ex:any,exType:any,progression:any){
 ...
 async function upsertSetLog(sid:string,fieldUpdates:Record<string,any>,opts?:{completed?:boolean}){
  ...
  const nextLogs={...logsRef.current,[sid]:data};
  if(updatingCompleted&&markComplete) maybeAutoAdvanceExercise(ex,nextLogs,located.workout);
  return data;
 }
