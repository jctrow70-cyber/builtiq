...
const weekWorkouts=(program?.st_workouts||[]).filter((w:any)=>w.week===week).sort((a:any,b:any)=>a.day_order-b.day_order);
 ...
 <main className="main page-main">
  ...
  {appNav==='Training'&&<section>
    ...
    {!program&&!activeAssignedRecipient&&trainingSubNav==='personal'&&<div className="card"><h2>No published program</h2><p className="muted">Finish and publish your plan in Program Setup to start logging workouts here.</p><button className="btn secondary" onClick={()=>setTrainingSubNav('setup')}>Program Setup</button></div>}
