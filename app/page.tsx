...
export default function Page(){
 ...
 async function loadPrograms(context:'training'|'setup'='training',options?:{assignmentsOverride?:Record<string,any>;editProgramId?:string|null}){
 ...
 if(field==='name'){
  ...
  const hit=matchExerciseToCatalog(trimmed,searchPool,catalogByName(searchPool));
