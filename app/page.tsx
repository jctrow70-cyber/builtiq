...
export default function Page(){
 ...
 function openGroupsProgramWizard(mode:'create'|'generate'){
 ...
 function generateProgramForMemberHandler(memberUserId:string){
  setGroupsAssignMemberUserId(memberUserId);
  openGroupsProgramWizard('generate');
 }
