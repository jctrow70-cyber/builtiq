# BuiltIQ Application Context

## Product Vision

BuiltIQ is an AI-powered health, fitness, and wellness platform.

The goal is not just workout tracking. BuiltIQ should become a complete personal fitness operating system combining:
